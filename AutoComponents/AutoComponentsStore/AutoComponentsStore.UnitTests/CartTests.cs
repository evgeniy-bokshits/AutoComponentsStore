...
namespace AutoComponentsStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Product game1 = new Product { ProductId = 1, Name = "Игра1" };
            Product game2 = new Product { ProductId = 2, Name = "Игра2" };
        ...
        public void Can_Remove_Line()
        {
            ...
            Product game1 = new Product { ProductId = 1, Name = "Игра1" };
            Product game2 = new Product { ProductId = 2, Name = "Игра2" };
            Product game3 = new Product { ProductId = 3, Name = "Игра3" };
        ...
        {
            // Организация - создание нескольких тестовых игр
            Product game1 = new Product { ProductId = 1, Name = "Игра1", Price = 100 };
            Product game2 = new Product { ProductId = 2, Name = "Игра2", Price = 55 };
